...
public class App 
{
    public static void main( String[] args )
    {
        try 
        {
            Document document = readXMLDocumentFromFile("C:/Users/ak1048135/Downloads/Abe's git folder/assign2_xml/src/lab.xml");
    ...
    public static void  computerInfo(NodeList n)
    {
